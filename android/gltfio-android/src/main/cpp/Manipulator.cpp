...
extern "C" JNIEXPORT void Java_com_google_android_filament_gltfio_Manipulator_nDestroyBuilder(JNIEnv*, jclass, jlong nativeBuilder) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGetMode(JNIEnv*, jclass, jlong nativeManip) {
    auto manip = (Manipulator<float>*) nativeManip;
    return (int) manip->getMode();
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nSetViewport(JNIEnv*, jclass, jlong nativeManip, jint width, jint height) {
    auto manip = (Manipulator<float>*) nativeManip;
    manip->setViewport(width, height);
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGetLookAt(JNIEnv* env, jclass, jlong nativeManip, jfloatArray eyePosition, jfloatArray targetPosition, jfloatArray upward) {
    auto manip = (Manipulator<float>*) nativeManip;
...
extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nRaycast(JNIEnv* env, jclass, jlong nativeManip, jint x, jint y, jfloatArray result) {
    auto manip = (Manipulator<float>*) nativeManip;
...
extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGrabBegin(JNIEnv*, jclass, jlong nativeManip, jint x, jint y, jboolean strafe) {
    auto manip = (Manipulator<float>*) nativeManip;
    manip->grabBegin(x, y, (bool) strafe);
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGrabUpdate(JNIEnv*, jclass, jlong nativeManip, jint x, jint y) {
    auto manip = (Manipulator<float>*) nativeManip;
    manip->grabUpdate(x, y);
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGrabEnd(JNIEnv*, jclass, jlong nativeManip) {
    auto manip = (Manipulator<float>*) nativeManip;
    manip->grabEnd();
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nZoom(JNIEnv*, jclass, jlong nativeManip, jint x, jint y, jfloat scrolldelta) {
    auto manip = (Manipulator<float>*) nativeManip;
    manip->zoom(x, y, scrolldelta);
}

extern "C" JNIEXPORT jlong JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGetCurrentBookmark(JNIEnv*, jclass, jlong nativeManip) {
    auto manip = (Manipulator<float>*) nativeManip;
    return (jlong) new Bookmark<float>(manip->getCurrentBookmark());
}

extern "C" JNIEXPORT jlong JNICALL Java_com_google_android_filament_gltfio_Manipulator_nGetHomeBookmark(JNIEnv*, jclass, jlong nativeManip) {
    auto manip = (Manipulator<float>*) nativeManip;
    return (jlong) new Bookmark<float>(manip->getHomeBookmark());
}

extern "C" JNIEXPORT void JNICALL Java_com_google_android_filament_gltfio_Manipulator_nJumpToBookmark(JNIEnv*, jclass, jlong nativeManip, jlong nativeBookmark) {
    auto manip = (Manipulator<float>*) nativeManip;
