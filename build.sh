...
function build_clean {
    ...
    rm -Rf android/utils-android/build android/utils-android/.externalNativeBuild
    rm -Rf android/utils-android/build android/utils-android/.cxx
}
...
function build_android {
    ...
    if [[ "$ISSUE_DEBUG_BUILD" == "true" ]]; then
        ...
        if [[ "$INSTALL_COMMAND" ]]; then
            ...
            echo "Installing out/utils-android-debug.aar..."
            cp utils-android/build/outputs/aar/utils-android-debug.aar ../out/
        fi
    fi
    ...
    if [[ "$ISSUE_RELEASE_BUILD" == "true" ]]; then
        ...
        if [[ "$INSTALL_COMMAND" ]]; then
            ...
            echo "Installing out/utils-android-debug.aar..."
            cp utils-android/build/outputs/aar/utils-android-release.aar ../out/
        fi
    fi
